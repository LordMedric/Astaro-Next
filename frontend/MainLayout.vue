...
const navGroups = [
  {
    ...
    items: [
      {
        id: 'control_center',
        aliases: ['dashboard', 'system_overview', 'resource_graphs'],
      ...
      {
        id: 'live_logs',
        aliases: ['logs', 'logging', 'conntrack', 'connections'],
        label: 'Live Logs & Conntrack',
        badge: 'Live Log',
        icon: LogsIcon
      },
      {
        id: 'executive_reports',
        aliases: ['reports', 'executive_report', 'analytics', 'bandwidth_usage', 'threat_reports'],
        label: 'Executive & Usage Reports',
        badge: 'Analytics',
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'ips',
        aliases: ['intrusion_prevention', 'suricata', 'antidos', 'portscan', 'snort'],
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'users',
        aliases: ['accounts', 'authentication', 'user_portal'],
      ...
      {
        id: 'network_services',
        aliases: ['dhcp', 'dns', 'dyndns', 'ntp', 'dhcp_server', 'dns_forwarders'],
  ...
  },
  {
    ...
    items: [
      {
        id: 'system_settings',
        aliases: ['settings', 'hostname', 'webadmin_settings', 'shell_access', 'notifications', 'reboot'],
        label: 'System & WebAdmin',
        badge: 'ACL/SSH',
