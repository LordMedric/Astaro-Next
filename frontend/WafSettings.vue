<template>
  <div class="space-y-6">
    ...
    <!-- Tab Navigation Strip (All 5 Astaro-Next Tabs) -->
    ...
    <!-- TAB 1: VIRTUAL WEBSERVERS (CARD LIST - MATCHING Astaro-Next LAYOUT WITH SNI & PER-SERVER CERTS) -->
      ...
      >
        <div class="p-5 flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-slate-100 bg-slate-50/50">
          <div class="flex items-start sm:items-center gap-3.5">
            <!-- Toggle Switch (Astaro-Next Green / Grey Style) -->
            <button
              type="button"
        ...
        <!-- Card Metadata Grid (Astaro-Next Structure with Certificate & SNI) -->
          ...
          <form @submit.prevent="saveVirtualServer" class="p-5 space-y-3.5 text-xs text-slate-800 max-h-[80vh] overflow-y-auto">
            ...
            <div>
              ...
              <select v-model="formVS.theme" class="w-full p-2 border border-slate-300 rounded bg-white font-medium">
                ...
                <option value="Astaro-Next Classic">Astaro-Next Classic</option>
              </select>
            </div>
...
// Astaro-Next matching Virtual Webservers with SNI & Certificate bindings
