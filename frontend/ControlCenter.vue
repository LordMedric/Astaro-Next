<template>
  <div class="space-y-6">
    ...
    <!-- ========================================================================= -->
    <!-- VIEW 4: HARDWARE, PARTITIONS & MAIL PIPELINE                              -->
    <!-- ========================================================================= -->
...
const mainTabs = computed(() => [
  { id: 'quadrant', label: 'Executive 4-Quadrant Control Center', icon: ControlCenterIcon, badge: 'Unified' },
  { id: 'traffic', label: 'Traffic & Flow Monitor', icon: TrafficIcon, badge: `${activeConnections.value.length} Flows` },
  { id: 'threats', label: 'Threat & Security Radar', icon: ThreatsIcon, badge: `${threatRadar.value.blocked_today || 1248} Drops` },
  { id: 'hardware', label: 'Hardware & Partition Health', icon: HealthIcon, badge: 'Optimal' }
])
